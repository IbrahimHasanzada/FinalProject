        ...
        <div className='wrapper font-["Montserrat",_sans-serif]'>
            <Link className='md:w-full  relative max-h-[654px] '>
                ...
                <section className=' h-full lg:h-[654px]'>
                    <div id='categoryImg' className='overflow-hidden h-full'>
                        <img className='w-full h-full' src="/img/kisi_1.jpg" alt="kisi" />
                    </div>
                </section>
            </Link>

            <section className='flex gap-5 justify-between flex-col md:flex-row items-center my-10'>
                <div className=' w-full md:w-[15%] text-center '>
                    <p className='uppercase text-[1.2em]'>Yeni Mehsullar</p>
                    <h2 className='my-6 text-6xl font-["Cormorant_Garamond",_serif]'>733</h2>
            ...
            <section className='w-full flex md:flex-row flex-col gap-8 mb-10'>
                <Link to='Brands'>
                    <div className='mb-3'>
