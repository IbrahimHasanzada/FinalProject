                ...
                <div className="flex flex-col">
                    <div className="flex items-center justify-center gap-4">
                        <form className=" h-11 lg:w-full w-[90%] pl-5 pr-2 flex items-center justify-between border my-5">
                            <input onChange={(e) => setSearch(e.target.value)} type="text" className="outline-none w-full" placeholder="Search..." />
                    ...
                    <div className="max-w-[700px]">
                        <ul className='flex py-2 lg:px-5 w-full overflow-scroll'>
                            <li onClick={() => setCatName('')} className={`py-1 px-2 ml-[2px] mb-1 cursor-pointer rounded-[3px]  hover:bg-[#e4e4e4] whitespace-nowrap ${!catName && 'bg-[#e4e4e4]'}`}>All</li>
