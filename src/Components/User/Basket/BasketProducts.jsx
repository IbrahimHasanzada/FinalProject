...
const BasketProducts = ({ addToCard, product }) => {
    ...
    const remCount = (count) => { 
        ...
        product.count <= 1 && deleteCards(product.product_id.id)
    }
    ...
    const { name, Size, quality, price, id, images } = product.product_id;
            ...
            <div className="relative flex items-start w-full">
                ...
                <section className='ml-4'>
                    <div className='mb-4'>
                        ...
                        <p className='text-[#777] uppercase text-sm'>size: {Size}</p>
                    ...
                    <button onClick={() => handleDeleteCard(id)} className='absolute right-0 top-0'>
